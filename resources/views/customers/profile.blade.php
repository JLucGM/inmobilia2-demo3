@php
$html_tag_data = [];
$title = __('message.Profile of') .' '.$user->name.' '.$user->last_name;
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 mb-4">
                            ...
                            {{ Form::text('whatsapp',null, ['class' => 'form-control' . ($errors->has('whatsapp') ? ' is-invalid' : ''), 'placeholder' => __('message.Phone')]) }}
